        ...
        public async Task ProcessRequestAsync()
        {
            ...
            try
            {
                ...
                if(httpRequest != null)
                {
                    ...
                    /*
                    if (httpRequest.Cookies.ContainsCookie("region"))
                    {
                        httpResponse.Cookies.AddCookie(new HttpCookie("region", "BG", false));
                    }
                    else
                    {
                        httpResponse.Cookies.AddCookie(new HttpCookie("region", "BG"));
                    }
                    */
